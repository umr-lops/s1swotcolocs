...
def mock_nc_dataset():
    ...
    ds.sar_start_time_slice.values = np.array(['2025-10-19T22:35:21'], dtype='datetime64[ns]')
...
def test_get_nasa_stac_info_failure(mock_client_open):
    ...
    res_id, res_url = converter.get_nasa_stac_info(datetime.now(), MagicMock(), "040", "224")
